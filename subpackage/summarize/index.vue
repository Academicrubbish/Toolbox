<template>
  <view class="container">
    ...
    <view
      ...
      :style="[{ height: 'calc(100vh - 145px - ' + CustomBar + 'px)' }]"
    >
      <editor
        id="editor"
        class="ql-container"
...
<script>
import { getSummarize, addSummarize, updateSummarize } from "@/api/summarize";
...
export default {
  ...
  methods: {
    submitContent: debounce(function () {
      // let text =
      //   '<span> </span><span style="color: #245bdb;">用户名称</span><span> </span>';
